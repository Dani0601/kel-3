...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Apr 2026 pada 03.58
...
(219, 'Ruangan Dibooking', 'Ruangan telah dibooking oleh dosen pada hari Kamis jam 15:30 - 18:00', '2026-04-23 17:25:31', 'dihapus'),
(220, 'Jadwal Hari Ini', 'Matematika Diskrit (07:30:00 - 10:00:00)', '2026-04-30 08:11:43', 'aktif'),
(221, 'Jadwal Hari Ini', 'Matematika Diskrit (10:00:00 - 12:30:00)', '2026-04-30 08:11:44', 'aktif'),
(222, 'Jadwal Hari Ini', 'Matematika Diskrit (07:30:00 - 10:00:00)', '2026-04-30 08:12:37', 'aktif');
...
--
ALTER TABLE `notifikasi`
  MODIFY `id_notifikasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;

--
-- AUTO_INCREMENT untuk tabel `notifikasi_user`
--
ALTER TABLE `notifikasi_user`
  MODIFY `id_notifikasi_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `tahun_ajaran`
  MODIFY `id_tahun_ajar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=717;
